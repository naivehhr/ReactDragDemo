	...
	constructor() {
		...
		this.state = {
			...
			relativeSchema: {
					...
					"jibenxinxi": {
						...
						"properties": {
							...
							"setting": {
								"type": "string",
								"title": "选择关联",
								"format": "relation-select",
								"$ref": "#/definitions/treeData"
							},
						},
						// "required": ["is_three_certificate_unit"]
					},
					"youxixinxi": {
						"type": "object",
						"title": "游戏信息",
				...
				"relation": {
					"youxixinxi.level": {
						rely: { "jibenxinxi.is_three_certificate_unit": [true, undefined] },
						invalidHidden: true
					},
					"youxixinxi.name": {
						rely: { "jibenxinxi.is_three_certificate_unit": [false, undefined] },
						invalidHidden: false
					},
					"jibenxinxi.isUnitInput": {
						rely: { "jibenxinxi.is_three_certificate_unit": [true, undefined] },
						invalidHidden: false
					}
				},
		...
		// console.log(JSON.stringify(this.state.relativeSchema, function (key, val) {
		// 	var seen = [];
